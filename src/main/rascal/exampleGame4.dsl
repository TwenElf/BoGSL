game: {
  ...
  rules: {
      rule moveInsideBoard: move piece any < boardsize || move piece any >= boardsize, 
      rule checkmateEndsGame:  other player can move piece any -> piece king and for (all moves piece king) other player capture king,
      rule captureOnMoveOver: move piece any -> other player piece any
  }
}
