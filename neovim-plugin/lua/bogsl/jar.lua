...
local function get_target_dir()
  ...
  return plugin_root .. "/target"
end

---Get the default location of `rascal.jar.
---@return string
function M.get_rascal_jar()
  return get_target_dir() .. "/rascal.jar"
end

---Get the default location of `rascal-lsp.jar.
---@return string
function M.get_rascal_lsp_jar()
  return get_target_dir() .. "/rascal-lsp.jar"
end

---Get the default location of `BoGSL*.jar`.
---@return string|nil
function M.get_bogsl_jar()
  ...
  while dir_data do
    if string.match(dir_data[1].name, "BoGSL.*%.jar") then
